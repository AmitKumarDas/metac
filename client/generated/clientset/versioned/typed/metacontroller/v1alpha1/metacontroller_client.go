...
import (
	...
	"openebs.io/metac/client/generated/clientset/versioned/scheme"
)
...
func (c *MetacontrollerV1alpha1Client) GenericControllers(namespace string) GenericControllerInterface {
	return newGenericControllers(c, namespace)
}
